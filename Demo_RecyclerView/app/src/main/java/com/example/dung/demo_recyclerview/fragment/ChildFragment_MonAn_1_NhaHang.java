...
public class ChildFragment_MonAn_1_NhaHang extends Fragment{
    TextView tv_reload;
    ...
    Context context;
    public ChildFragment_MonAn_1_NhaHang(){
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final String maNhaHang = getArguments().getString("MA_NHA_HANG");
        initialData(maNhaHang, tabCategory);
...
//        }
    ...
    private void initialData(String _maNhaHang, String _tabCategory){
        progressBar.setVisibility(View.VISIBLE);
        //isShowAlertDialog = false;
