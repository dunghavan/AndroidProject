...
//     * @param randomNonce A random nonce as transferred in the request body to randomize the request. Use {Nonce#createRandomNonce()} to generate a random nonce.
...
//     */
//    public String signature(final String stringToSign, final String apiSecret) {
//
...
//            byte[] keyDecoded = Base64.Decoder.decode(apiSecret.getBytes(UTF_8));
